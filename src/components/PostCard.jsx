...
export default function PostCard({ post }) {
  ...
  return (
    <article className="post-card">
      ...
      <div className="post-card__body" onClick={openPost} role="button" tabIndex={0}
      ...
      <div className="post-card__footer">
        <button
          type="button"
          className={`post-card__like${post.liked ? " is-liked" : ""}`}
          onClick={(e) => {
            stop(e);
            toggleLike(post.id);
          }}
        ...
        >
          <svg width="19" height="19" viewBox="0 0 24 24" fill={post.liked ? "currentColor" : "none"}>
            <path
        ...
        <button type="button" className="post-card__comment" onClick={openPost}>
